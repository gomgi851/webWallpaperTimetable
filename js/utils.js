...
// 시간 범위 생성
function getTimeRange(startH, startM, endH, endM) {
...
// 시간과 요일로부터 위치 계산
function calculatePosition(day, start, end, gridWidth, gridHeight, timeStart = 420, timeEnd = 1020) {
  ...
  return { x, y, width: gridWidth / DAYS.length, height };
}

// 캔버스에서 텍스트가 주어진 너비에 맞는 폰트 크기 찾기
function findFontSizeForWidth(ctx, text, maxWidth, baseFontSize = 20) {
...
function extractPaletteFromImage(img, nColors = 8, sampleRate = 10) {
